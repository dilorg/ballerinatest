...
@kubernetes:Deployment {
  ...
  name:"ballerina-guides-travel-agency-service",
  dockerCertPath:"/home/dilhasha/.minikube/certs",
...
http:Client airlineReservationEP = new("http://10.100.7.143:9091/airline");

// Client endpoint to communicate with Hotel reservation service
http:Client hotelReservationEP = new("http://10.100.7.143:9092/hotel");

// Client endpoint to communicate with Car rental service
http:Client carRentalEP = new("http://10.100.7.143:9093/car");
